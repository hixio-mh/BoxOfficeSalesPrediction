...
defaultdataset = pd.read_csv('DefaultDataset.csv')
...
def Coefficient12Result():
	if database_Used == 1:
		...
		print(database_coefficients1and2)
...
def Coefficient34Result():
	if database_Used == 1:
		...
		print(database_coefficients3and4)
...
#print(temp.loc[0])
	...
	print (database_predictedvalues)
	#print(dt)
